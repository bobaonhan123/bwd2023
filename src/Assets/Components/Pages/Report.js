        ...
        <div className="report" >
          ...
          <div className="container" style={{width: "80%"}}>
            ...
            <div className="row">
                ...
                <div><img className="report_img_1" src="external/Thuc-trang-cong-tac-phong-chay-chua-chay-rung1.jpg "></img></div>
            </div>
            <div className="row">
                <img className="report_img_1" src="external/van-nan-chay-rung-o-viet-nam.jpg"></img>
            ...
            <div className="row" style={{ paddingBottom: "0px"}}>
                ...
                <img className="report_img_1" src="external/5-9chay.jpg "></img>
