...
function Header() {
    ...
    const [link3,setLink3]=useState(window.location.pathname.includes("/Report")?"curr-page":"");
  ...
  return (
    <div className={HeaderClass}>
        ...
        <ul className="navbar">
            ...
            <li key='3'><Link to="/Report" className={link3}>Báo cáo</Link></li>
        ...
        <ul className={barClass} style={mobileNavStyle}>
            ...
            <li key='3' onClick={handleBar}><Link to="/Report" className={link3}>Báo cáo</Link></li>
